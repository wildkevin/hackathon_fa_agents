...
This script creates and configures a yoy agent using Azure AI Projects.
The agent is designed to cleans the raw data and calculate YOY (Year Over Year) metrics.
"""
...
def main() -> None:
    ...
    try:
        ...
        # Success output
        logger.info("YOY agent creation completed successfully")
        print(f"✅ YOY agent created successfully!")
